  ...
  "housing": {
    ...
    "items": [
      ...
      },
      {
        ...
        "type": "info",
        "resource": "Az-Housing / az-housing-qbcore",
        "description": "Police jobs configured in housing config can breach/force access through the housing target/menu flow. This is job/permission checked by the housing resource, not bypassed by AMenu."
      }
    ]
  },
  "outdoors": {
  ...
  "drugs": {
    ...
    "items": [
      ...
      },
      {
        ...
        "type": "info",
        "resource": "ps-drugprocessing",
        "description": "Cocaine, meth, heroin, LSD/chemicals, acid/sodium/sulfuric, and weed flows are mostly target/item/location driven. Players should use configured locations, items, and qb-target interactions rather than a AMenu button that teleports or grants drugs."
      },
      {
        "label": "Cocaine Flow",
        "type": "info",
      ...
      },
      {
        ...
        "description": "This AMenu only exposes safe help/cleanup. It does not add buttons that grant product, skip processing, bypass item checks, or reveal hidden locations."
      }
    ]
  },
  "camping": {
  ...
  "jobs": {
    ...
    "items": [
      ...
      },
      {
        ...
        "description": "Gardening jobs are generally configured through in-world zones/items. Use the resource interaction points; AMenu does not grant items or skip the job flow."
      },
      {
